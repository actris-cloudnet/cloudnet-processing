...
STATUS_CODES_V2 = [
    ...
    ("laser_optical_module_temperature_error", 1),
    ("laser_trigger_error", 1),
    # Introduced in 0.733, combined with 'mainboard_error' in 1.070:
    ("firmware_error", 1),
