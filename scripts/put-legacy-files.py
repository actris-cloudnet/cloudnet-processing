...
def main():
    ...
    for site in sites:
        ...
        for dir_name in dir_names:
            files = _get_files(ARGS.root[0], site, dir_name)
...
def _check_if_exists(md_api, info: dict):
    ...
    try:
        ...
        raise err
    if metadata:
        raise MiscError('Legacy file already uploaded')
...
def _get_files(root_path: str, site: str, dir_name: str) -> Generator:
    full_path = os.path.join(root_path, site, dir_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument('root',
                        nargs='+',
                        help='Root path including the site directories, e.g., '
                             '/ibrix/arch/dmz/cloudnet/data/')
