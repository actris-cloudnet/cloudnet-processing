...
class TestCloudnetProcessing:
    ...
    def test_that_calibrated_lidar_file_exists(self):
    ...
    def test_that_calibrated_radar_file_exists(self):
    ...
    def test_that_categorize_file_exists(self):
    ...
    def test_that_product_files_exist(self):
